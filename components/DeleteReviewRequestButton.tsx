...
interface DeleteReviewRequestButtonProps {
  requestId: string
...
export default function DeleteReviewRequestButton({
  requestId,
  requestAuthorEmail,
  currentUserEmail,
  onRequestDeleted
}: DeleteReviewRequestButtonProps) {
  ...
  if (currentUserEmail !== requestAuthorEmail) return null
